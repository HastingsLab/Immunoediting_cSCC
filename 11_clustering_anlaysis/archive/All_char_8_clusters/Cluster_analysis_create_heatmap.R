...
data <- data[-which(data$netMHC_II_binding==Inf),]
data_raw <- data
...
data$max_stability <- scale(log(as.numeric(data$max_stability)+0.01,10), center=TRUE)
...
#range(C2$min_binding)
#range(C7$min_binding)
#range(C2$max_stability)
#range(C7$max_stability)
#t.test(C2$max_stability, C7$max_stability)
#t.test(C2$min_binding, C7$min_binding)
...
C1 <- summary_plot[which(summary_plot$variable=="C1"),]
C_ich_c <- C1[which(C1$immune_clonal=="high_Clonal"),]
C_ich_sc <- C1[which(C1$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C1[which(C1$immune_clonal=="low_Clonal"),]
C_icl_sc <- C1[which(C1$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C1[which(C1$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C1[which(C1$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C1_boxplot.pdf")
ggplot(C1, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C2 <- summary_plot[which(summary_plot$variable=="C2"),]
C2_ich_c <- C2[which(C2$immune_clonal=="high_Clonal"),]
C2_ich_sc <- C2[which(C2$immune_clonal=="high_Sub-clonal"),]
C2_icl_c <- C2[which(C2$immune_clonal=="low_Clonal"),]
C2_icl_sc <- C2[which(C2$immune_clonal=="low_Sub-clonal"),]
C2_is_c <- C2[which(C2$immune_clonal=="Suppressed_Clonal"),]
C2_is_sc <- C2[which(C2$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C2_boxplot.pdf")
ggplot(C2, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C3 <- summary_plot[which(summary_plot$variable=="C3"),]
C_ich_c <- C3[which(C3$immune_clonal=="high_Clonal"),]
C_ich_sc <- C3[which(C3$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C3[which(C3$immune_clonal=="low_Clonal"),]
C_icl_sc <- C3[which(C3$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C3[which(C3$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C3[which(C3$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C3_boxplot.pdf")
ggplot(C3, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C4 <- summary_plot[which(summary_plot$variable=="C4"),]
C_ich_c <- C4[which(C4$immune_clonal=="high_Clonal"),]
C_ich_sc <- C4[which(C4$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C4[which(C4$immune_clonal=="low_Clonal"),]
C_icl_sc <- C4[which(C4$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C4[which(C4$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C4[which(C4$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C4_boxplot.pdf")
ggplot(C4, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C5 <- summary_plot[which(summary_plot$variable=="C5"),]
C_ich_c <- C5[which(C5$immune_clonal=="high_Clonal"),]
C_ich_sc <- C5[which(C5$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C5[which(C5$immune_clonal=="low_Clonal"),]
C_icl_sc <- C5[which(C5$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C5[which(C5$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C5[which(C5$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C5_boxplot.pdf")
ggplot(C5, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C6 <- summary_plot[which(summary_plot$variable=="C6"),]
C_ich_c <- C6[which(C6$immune_clonal=="high_Clonal"),]
C_ich_sc <- C6[which(C6$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C6[which(C6$immune_clonal=="low_Clonal"),]
C_icl_sc <- C6[which(C6$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C6[which(C6$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C6[which(C6$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C6_boxplot.pdf")
ggplot(C6, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()


C7 <- summary_plot[which(summary_plot$variable=="C7"),]
C_ich_c <- C7[which(C7$immune_clonal=="high_Clonal"),]
C_ich_sc <- C7[which(C7$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C7[which(C7$immune_clonal=="low_Clonal"),]
C_icl_sc <- C7[which(C7$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C7[which(C7$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C7[which(C7$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C7_boxplot.pdf")
ggplot(C7, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()

C8 <- summary_plot[which(summary_plot$variable=="C8"),]
C_ich_c <- C8[which(C8$immune_clonal=="high_Clonal"),]
C_ich_sc <- C8[which(C8$immune_clonal=="high_Sub-clonal"),]
C_icl_c <- C8[which(C8$immune_clonal=="low_Clonal"),]
C_icl_sc <- C8[which(C8$immune_clonal=="low_Sub-clonal"),]
C_is_c <- C8[which(C8$immune_clonal=="Suppressed_Clonal"),]
C_is_sc <- C8[which(C8$immune_clonal=="Suppressed_Sub-clonal"),]
...
pdf("C8_boxplot.pdf")
ggplot(C8, aes(x=immune_clonal, y=as.numeric(value))) + geom_boxplot(outlier.shape = NA) + geom_jitter(width=0.05) + theme_minimal()
dev.off()
